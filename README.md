...
- **[stock-price-prediction]()**: analysis of time series, data and feature engineering as a base to develop predictive models that can forecast future stock index value prices of an index based on historical data.
